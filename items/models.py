...
class Item(models.Model):  # The Model is what will create the database for the product. 
    name = models.CharField(max_length=25, blank='')  # Empty default will not add a default porduct into the database.
